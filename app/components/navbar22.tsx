...
const Navbar22 = () => {
  ...
  const t = useTranslations('navbar22');
  const navLinks = t.raw('navLinks') as Array<{name: string; href: string}>;
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="absolute left-1/2 hidden -translate-x-1/2 transform md:block">
                <a href="/" className="flex items-center gap-2" aria-label="LupoBau AG Homepage">
                  <img
                    src="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/logos/shadcnblockscom-icon.svg"
                    className="max-h-8"
                    alt={t('logo')}
